<?
/* Início de seção.
   Este comando, do <? ao ?> só pode ser colocado aqui! Serve para usar a mesma variável em várias páginas.
   Deve ser colocado em todas as páginas que precisam usar as variáveis globais. */
session_start();
?>
